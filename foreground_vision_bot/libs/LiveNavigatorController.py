...
class LiveNavigatorController:
    ...
    def __init__(
        ...
        *,
        ...
        # Unified farming only needs the persistent key executor and EVA helper.
        # Do not load or construct the retired goal-conditioned movement policy
        # in that mode.  The default remains True for legacy navigation tools.
        self.policy: _PolicyAdapter | None = None
        self.core: NavigatorSimulatorCore | None = None
    ...
    def navigate_toward_cell(
        ...
        *,
        ...
        if self.policy is None or self.core is None:
            raise RuntimeError(
                "Goal navigation is disabled for the unified farming controller"
            )
        duration = (
