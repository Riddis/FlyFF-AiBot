...
Usage:
    ...
    python calibration_capture.py --capture --seconds 60 --out FILE.csv [--rate-hz 40]
...
from recorder.native_capture import AttachedNativeClient, attach_native_client
from recorder.windows import find_client_windows, foreground_window
from position.IndependentNativeReader import IndependentNativeReadError
