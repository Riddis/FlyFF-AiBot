...
REQUIRED_FILES: tuple[str, ...] = (
    ...
    "scratchpad/scratchpad_general_router_episode.py",
    "scratchpad/scratchpad_beginner_navigation_mix_pools.py",
    "scratchpad/scratchpad_legacy_qualified_selector.py",
