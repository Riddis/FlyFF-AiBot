...
def main() -> None:
    ...
    manifest = load_manifest(ROOT / "evaluations" / f"monster_approach_smoke_pool_{SMOKE_POOL_SPEC_SEED}_manifest.json")
    ...
    out_path = ROOT / "evaluations" / "monster_approach_smoke_eval_result.json"
