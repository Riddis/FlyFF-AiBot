...
Usage:
    python -m devtools.archives.inventory_recordings recordings/training recordings/eva_only
    python -m devtools.archives.inventory_recordings --output recordings/INDEX.json recordings/**/*.zip
"""
