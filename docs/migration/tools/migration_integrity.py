...
DEFAULT_BRIDGES = "docs/migration/BRIDGES.md"
...
DEFAULT_SUPPLEMENTS = (
    ...
    "docs/migration/POST_TARGET_SELECTION_R7C_SUPPLEMENT.tsv",
    "docs/migration/POST_PREMERGE_OWNERSHIP_R7C_SUPPLEMENT.tsv",
)
