...
1. [System overview](architecture/SYSTEM_OVERVIEW.md) — what this
   application is, its entrypoints, process architecture
2. [Component ownership & dependency boundaries](architecture/COMPONENT_OWNERSHIP.md)
   — what owns what, and the compatibility-facade rules
3. Domain-specific architecture docs (below) — read only the ones your
   task touches
4. [Testing & gates](operations/TESTING_AND_GATES.md) — what to run and
   what "passing" means
5. [Known debt & open questions](KNOWN_DEBT.md)
6. [Validation status](validation/README.md)
7. [Decisions](decisions/README.md)
8. `docs/migration/` — historical/forensic evidence of how the
...
9. [Agent rules](agent/PROJECT_RULES.md) — if you are an AI agent
