...
Final run (this document's evidence, after the two test fixes and before the documentation-completion commit): **3 failed, 1203 passed, 2 skipped, 1 xfailed** — the self-inflicted forward-reference (expected to clear once `PHASE14_REPORT.md` is committed) plus exactly 2 of the original 4 established failures. See section 7 for the individual audit of the 4 originally-established failures.
