...
$output = "evaluations\reward_audit_v18_${tag}.json"
$args = @(
...
Write-Host "v1.8 reward audit: $EpisodesPerLayout episode(s)/layout, $EpisodeSeconds simulated seconds, layout limit $LayoutLimit (0 = all)."
& $python @args
