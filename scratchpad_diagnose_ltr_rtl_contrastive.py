...
def main() -> None:
    ...
    manifest = load_manifest(ROOT / "evaluations" / f"router_mix_dev_pool_{DEV_POOL_SPEC_SEED}_manifest.json")
    ...
    output_path = ROOT / "evaluations" / "diagnose_ltr_rtl_contrastive.json"
