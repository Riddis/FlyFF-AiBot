...
TARGET_LAYOUTS = [
    ...
    ("simulator/evaluations/manifests/early_heldout_unseen_templates.json", "05_early_broad_lobes_typical_fast", "substantial regression"),
    ("simulator/evaluations/manifests/early_heldout_unseen_templates.json", "04_early_split_field_high_bursty", "substantial regression"),
    ("simulator/evaluations/manifests/early_heldout_unseen_templates.json", "07_early_open_center_typical_fast", "minor regression"),
    ("simulator/evaluations/manifests/early_heldout_unseen_templates.json", "08_early_open_center_high_bursty", "minor regression"),
    ("simulator/evaluations/manifests/early_heldout.json", "06_early_wide_neck_high_typical", "minor regression"),
    ("simulator/evaluations/manifests/early_heldout.json", "03_early_open_field_low_fast", "biggest improvement (-107)"),
    ("simulator/evaluations/manifests/early_heldout.json", "08_early_wide_neck_typical_bursty", "large improvement (-73)"),
]
...
def main():
    ...
    (ROOT / "simulator" / "evaluations" / "oracle_v3_terminal_gate_onset_diagnosis.json").write_text(
