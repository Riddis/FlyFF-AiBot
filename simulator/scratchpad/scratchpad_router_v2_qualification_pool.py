...
def main() -> None:
    manifest_path = ROOT / "simulator" / "evaluations" / f"router_mix_qualification_pool_{QUALIFICATION_SPEC_SEED}_manifest.json"
    ...
    checksums_path = ROOT / "simulator" / "evaluations" / f"router_mix_qualification_pool_{QUALIFICATION_SPEC_SEED}_checksums.json"
