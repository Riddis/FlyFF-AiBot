...
def _load_actual_headings() -> dict[int, float]:
    ...
    result_path = ROOT / "simulator" / "evaluations" / f"monster_approach_baseline_{FULL_POOL_SPEC_SEED}_result_corrected.json"
...
def main() -> None:
    ...
    out_path = ROOT / "simulator" / "evaluations" / "monster_approach_obstacle_geometry_audit.json"
