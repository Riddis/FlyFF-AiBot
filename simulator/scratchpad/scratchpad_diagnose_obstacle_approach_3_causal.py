...
def main() -> None:
    ...
    corrected_result = json.loads((ROOT / "simulator" / "evaluations" / f"monster_approach_baseline_{FULL_POOL_SPEC_SEED}_result_corrected.json").read_text(encoding="utf-8"))
    ...
    out_path = ROOT / "simulator" / "evaluations" / "diagnose_obstacle_approach_3_causal.json"
