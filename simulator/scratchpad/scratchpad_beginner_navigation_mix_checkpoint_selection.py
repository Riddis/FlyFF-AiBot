...
BASELINE_EVAL_PATH = ROOT / "simulator" / "evaluations" / "router_mix_dev_pool_baseline_eval.json"
...
def main() -> None:
    ...
    for seed in CONTINUATION_SEEDS:
        log_path = ROOT / "simulator" / "evaluations" / f"generalized_waypoint_router_mix_seed{seed}_checkpoint_evals.json"
    ...
    out_path = ROOT / "simulator" / "evaluations" / "router_mix_checkpoint_selection_result.json"
