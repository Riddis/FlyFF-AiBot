...
def _spot_check_old_selector_fidelity() -> None:
    ...
    preserved = json.loads((ROOT / "simulator" / "evaluations" / "audit_selector_fallback_pre_selector_patch.json").read_text(encoding="utf-8"))
...
def main() -> None:
    ...
    out_path = ROOT / "simulator" / "evaluations" / "router_patch_qualification_compare_result.json"
